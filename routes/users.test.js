...
describe("POST /users", function () {
  ...
  test("works for admin: create non-admin with random password", async function () {
    const resp = await request(app)
      .post("/users")
      .send({
        username: "u-new",
    ...
    const userInDb = await User.get("u-new");
    expect(userInDb.password).not.toEqual(null);
    expect(userInDb.password).not.toEqual("");
    expect(userInDb.password).not.toEqual("password-new");
  });
